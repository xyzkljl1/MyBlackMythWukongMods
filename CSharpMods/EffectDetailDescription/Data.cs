...
namespace EffectDetailDescription
{
    static public class Data
    {
        ...
        public static DescDict SpiritDesc = new DescDict
        {
            ...
            {8033,new Desc{ "",""}}, //"石父"
            {8034,new Desc{ "", ""}}, //"地罗刹"
            {8035,new Desc{ "", ""}}, //"鳖宝"--303184/33484 Passive 292/272，1061301,1061401,1021301,1021401,1086301,1086401,1088301,1088401
            {8036,new Desc{ "",""}}, //"燧统领"
            {8037,new Desc{ "",""}}, //"燧先锋"
            {8038,new Desc{ "", ""}}, //"琴螂仙"
            {8039,new Desc{ "", ""}}, //"火灵元母"
            ...
            {8076,new Desc{ "+[2]%/[2.5]%/[3]%", "+[2]%/[2.5]%/[3]%"}}, //"巡山鬼"--303686 [254]/[274]/[294] [1061410]/[1061430]/[1061460]?    Hook IsAttackCrit实测，加算
        };
